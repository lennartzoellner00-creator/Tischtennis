/* ═══════════════════════════════════════════════════════════════════
   ...
   Alle Daten im localStorage. Kein Server nötig.
═══════════════════════════════════════════════════════════════════ */

const START_ELO   = 1000;
const K           = 32;
const MAX_DELTA   = 20;
const STORAGE_KEY = "tt_elo_v2";
...
function ladeDaten() {
  ...
  return { spieler: {}, spiele: [], turniere: [] };
}
function speichereDaten() {
  localStorage.setItem(STORAGE_KEY, JSON.stringify(daten));
}
let daten = ladeDaten();
if (!daten.turniere)  daten.turniere  = [];
...
// Admin-PIN: Default "4321" beim ersten Start initialisieren
