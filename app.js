...
function onFirebaseDaten(snapshot) {
  ...
  if (remote) {
    // Arrays sicherstellen (Firebase kann Arrays als Objekte zurückgeben)
    daten = remote;
    daten.spiele     = Object.values(daten.spiele     || {});
    daten.turniere   = Object.values(daten.turniere   || {});
    daten.eloEvents  = Object.values(daten.eloEvents  || {});
